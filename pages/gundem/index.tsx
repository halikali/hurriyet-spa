...
export async function getServerSideProps(context: any) {
    ...
    const galleryNews = getGalleryNews("gündem").then(item => item.data.data.map((obj: any): any => ({
        ...obj,
        ancestor: '/galeri'
    })));
    const newsDetail = getNewsDetail("gündem").then(item => item.data.data.map((obj: any): any => ({
        ...obj,
        ancestor: ''
    })));
